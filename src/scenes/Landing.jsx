      ...
      <div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center md:order-2">
        {isAboveLarge ? (
          ...
          >
            <img
              alt="profile"
              className="hover:filter hover:saturate-200 transition duration-500 z-10 w-full max-w-[400px] md:max-w-[600px] shadow-lg rounded-full max-w-full h-auto align-middle border-none"
          ...
          <img
            alt="profile"
            className="z-10 w-full max-w-[400px] md:max-w-[600px] shadow-lg rounded-full max-w-full h-auto align-middle border-none"
            src="assets/LogoMockup.png"
          />
        )}
      </div>
