    ...
    <section id="register" className="mt-32">
      ...
      >
        <div className="w-full mx-auto relative  text-center ">
          ...
          <a href="https://drive.google.com/file/d/1yWtWE_OyTmsIHPiIu_jdzZf9muKP02NV/view?usp=sharing" target="_blank"rel="noopener noreferrer">
